...
<body class="bg-gray-200">
  ...
  <main class="main-content  mt-0">
    <div class="page-header align-items-start min-vh-100" style="background-image: url('assets/img/fisio.jpg'); width: 100%; height: 100hv; background-size: cover;">
              ...
              <div class="card-body">
                <form  class="text-start" method="POST">
                  ...
                  <p class="mt-4 text-sm text-center">
                   No posee una Cuenta ?
                    <a href="#" class="text-primary text-gradient font-weight-bold">Registrase</a>
                  </p>
                  <?php if($alert != ""){  ?>
