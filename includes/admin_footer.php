    ...
    <div class="card shadow-lg">
      <div class="card-header pb-0 pt-3">
        <div class="float-start">
          <h5 class="mt-3 mb-0">Estilos para la Pagina</h5>
          <p>Estilza tu pagina a tu gusto.</p>
        </div>
      ...
      <div class="card-body pt-sm-3 pt-0">
        <!-- Sidebar Backgrounds -->
        <div>
          <h6 class="mb-0">Colores para el menu de navegación</h6>
        </div>
        ...
        <!-- Sidenav Type -->
        <div class="mt-3">
          <h6 class="mb-0">Color de fondo para el menu</h6>
          <p class="text-sm">Seleccione el color que vaya con su gusto. <i class="material-icons" style="color: yellow;">tag_faces</i></p>
        </div>
        <div class="d-flex">
        ...
        <div class="mt-2 d-flex">
          <h6 class="mb-0">Brillante / Oscuro</h6>
          <div class="form-check form-switch ps-0 ms-auto my-auto">
        ...
        <hr class="horizontal dark my-sm-4">
          ...
          <h6 class="mt-3">La Fisioterapia es aquella pasión  de sanar el cuerpo con el movimiento, con la mente.... y fundamentalmente con el corazón
