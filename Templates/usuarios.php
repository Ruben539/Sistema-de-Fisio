          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Usuarios del Sistema
                  
                <a class="btn btn-outline-danger" href="../View/agregarUsuario.php">
            ...
            <div class="card-body px-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0" id="tabla_Usuario">
                  ...
                  <tbody>
                  <?php 
                        $sql = mysqli_query($conection," SELECT u.id,u.cedula,u.nombre,u.correo,u.usuario,r.descripcion 
                        FROM usuario u INNER JOIN roles r ON u.rol = r.id  where u.rol > 1 AND u.estado = 1 ORDER BY  u.id DESC");
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm"><?php echo $data['cedula'];?></h6>
                      ...
                      <td>
                        <p class="text-center font-weight-bold mb-0"><?php echo $data['correo'];?></p>
                      </td>
                      ...
                      <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold"><?php echo $data['descripcion'];?></span>
                      </td>
                      <?php if ($_SESSION['rol'] == 1 || $_SESSION['rol'] == 2) {?>
                          <td>
                             <a href="../View/modificarUsuario.php?id=<?php echo $data['id']; ?>"class="btn btn-outline-info" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.3), 0 6px 20px  rgba(0, 0, 0, 0.25);"><i class="fas fa-edit"></i></a>
                          </td>
                      <?php } ?>
                      <?php if($_SESSION['rol'] == 1 ){ ?>
                          <td>
                            <button onclick="EliminarUsuario('<?php echo $data['id']; ?>')"
